...
{
    public class TimerWithLambda : ICountDownNotifier
    {
        ...
        public TimerWithLambda(Timer timer, TimerTickHandler OnCountdownStared, TimerTickHandler OnCountdownFinished)
        {
            _timer = timer;
            ...
            _NSecondsRemaining = (object sender, TimerTickEventArgs args) =>
