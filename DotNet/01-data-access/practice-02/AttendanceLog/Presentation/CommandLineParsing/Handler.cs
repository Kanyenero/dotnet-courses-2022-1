...
namespace AttendanceLog.Presentation.CommandLineParsing
{
    public class Handler
    {
        private RootCommand rootCommand = default!;

        private BusinessLogic.Student.IDataProvider studentDataProvider;
        private BusinessLogic.Lecture.IDataProvider lectureDataProvider;
        private BusinessLogic.Attendance.IDataProvider attendanceDataProvider;
        private BusinessLogic.Database.IDataProvider databaseDataProvider;
        ...
        private Command CreateStudentCommand()
        {
            ...
            {
                int studentId = studentDataProvider.Add(student);
        ...
        private Command CreateLectureCommand()
        {
            ...
            {
                int lectureId = lectureDataProvider.Add(lecture);
        ...
        private Student ValidateStudentCommandArgumentResult(string optionName, int[] expectedTokensCounts, ArgumentResult argumentResult)
        {
        ...
        private Lecture ValidateLectureCommandArgumentResult(string optionName, int[] expectedTokensCounts, ArgumentResult argumentResult)
        {
        ...
        private Attendance ValidateAttendCommandArgumentResult(string optionName, int[] expectedTokensCounts, ArgumentResult argumentResult)
        {
        ...
        private Student ValidateStudentDataTokens(int[] expectedTokensCounts, ArgumentResult argumentResult)
        {
        ...
        private Lecture ValidateLectureDataTokens(int[] expectedTokensCounts, ArgumentResult argumentResult)
        {
            int actualTokensCount = argumentResult.Tokens.Count;
        ...
        private Attendance ValidateAttendDataTokens(int[] expectedTokensCounts, ArgumentResult argumentResult)
        {
            int actualTokensCount = argumentResult.Tokens.Count;
